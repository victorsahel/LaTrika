...
class SideMenuItem extends React.Component
{
    ...
    render() 
    {
        ...
        return (
            <li  className={`first_level ${subMenuClass} ${activeClass}`}>
                <a onClick={this.handleClick} href={item._links}>
                        ...
                        {!item.submenu ? '' :
                            <ul style={subMenuVisible}>
                                ...
                                {item.submenu.map((subItem, i) => (
                                        <li key={i}>
                                            <a className="submenu-link" href={subItem.link || "/videos"}>
                                                {subItem.nombre || subItem.title}
                                            </a>
